...
<head>
    ...
    <title>SukaPerpus Detail</title>
    <link href="<?php echo base_url();?>assets/client/css/detail.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="detail-wrap">
      <div class="detail-left">
        <img src="<?php echo base_url();?>/assets/client/images/logo.png" alt="" width="260" height="200" />
        <br />
        <br />
        <div class="flex w100">
          <p class="detail-info-book params">PUBLISHED</p>
          <p class="params">:</p>
          <p class="params">&nbsp &nbsp 1932</p>
        </div>
        <div class="flex w100">
          <p class="detail-info-book params">GENRE</p>
          <p class="params">:</p>
          <p class="params">&nbsp &nbsp Romance</p>
        </div>
        <div class="flex w100">
          <p class="detail-info-book params">READS</p>
          <p class="params">:</p>
          <p class="params">&nbsp &nbsp 12.420</p>
        </div>
      </div>

      <div class="detail-right">
        <h3 class="font-judul">ROMEO AND ASEP</h3>
        <div class="flex w100">
          <p class="detail-info-book params">Descriptions</p>
          <p class="params">:</p>
          <p class="params">&nbsp &nbsp</p>
        </div>
        <br />
        <br />
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, nam!
          Impedit asperiores excepturi soluta odio dolor qui facere quasi minima
          ad. Dolor beatae rem iusto aliquam quas. Non, perspiciatis eos. ad.
          Dolor beatae rem iusto aliquam quas. Non, perspiciatis eos. ad. Dolor
          beatae rem iusto aliquam quas. Non, perspiciatis eos. Lorem ipsum
          dolor sit amet consectetur adipisicing elit. Quibusdam vel, magni
          dolores, quam quis expedita recusandae atque nobis molestias vitae
          laborum? Mollitia dolore accusantium id repudiandae, necessitatibus
          modi sed omnis.
        </p>
        <br />
        <br />
